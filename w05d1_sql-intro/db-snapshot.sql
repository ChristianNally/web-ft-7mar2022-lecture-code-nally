...
INSERT INTO public.curricula (id, description) VALUES (1, 'Web Dev Bootcamp');
...
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (5, 22, 'learning', 'How do I establish a relationship between tables?', 'You can establish a relationship between tables by creating a column that tells you, for each row, which row in another table it is related to.', 5, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (27, 22, 'learning', 'What are the features required of a primary key?', 'A Primary Key must be unique (within the table) and can never be null.', 6, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (28, 22, 'learning', 'What is the most common data type for a Primary Key?', 'A Primary Key''s data type is usually auto-incrementing integer (INTEGER or BIGINT).', 7, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (29, 22, 'learning', 'What is a Foreign Key?', 'A Foreign Key is a column on a second table, where the value in a given row indicates an association with a row from the first table. The Foreign Key value on the second table matches the Primary Key value from the first table.', 8, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (32, 22, 'learning', 'What is an ERD?', 'ERD; an Entity Relationship Diagram is a diagram that shows the relationships established between entities within a system. For databases, this is more often with regard to relationships between tables.', 0, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (13, 16, 'learning', 'What is the box model?', 'The box model is how DOM elements are typically rendered to occupy a certain amount of screen real estate, via padding, borders and margins.', 4, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (18, NULL, 'learning', 'What is DOM traversal?', 'DOM traversal is the ability of client-side javascript to jump from one node to a parent, sibling or child, step by step throughout the DOM, looking for elements that match a certain criteria.', NULL, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (36, 23, 'performance', 'How do we prevent a SQL Injection attack?', 'client.query(''SELECT * FROM <table> WHERE id = $1'', [<id>])   
.then((result) => console.log(result));', 4, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (35, 23, 'learning', 'What is a SQL injection attack?', 'A malicious user crafts input for a form submission that will be mistakenly input directly into a database. That input might be any SQL query, including dropping tables or deleting rows. ', 3, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (34, 23, 'performance', 'How, given a postgres client object, do you submit queries to the database from back-end javascript?', 'client.query(''SELECT * FROM <table>'')
   .then((result) => console.log(result));', 2, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (40, 12, 'learning', 'In the context of web programming, what is a template?', 'A template is a file containing mainly HTML, but with syntactic morsels of dynamic content.', 3, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (20, 17, 'performance', 'How do you traverse the DOM with jQuery?', '$(''.parent'').children().addClass("tagged");', 4, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (2, 21, 'learning', 'What is a database?', 'A database is a collection of tables. The collection is typically used as a set. A connection to a database is granted via a username and password.', 3, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (4, 21, 'learning', 'What is a WHERE clause?', 'A query can filter or restrict the information that results via a WHERE clause.', 4, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (6, 21, 'learning', 'What is a JOIN clause?', 'The data that a query has access to, can be expanded via JOIN-ing two tables together.', 6, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (3, 21, 'learning', 'What is a query?', 'A query is a task executed against a database, table or combination of tables. e.g. SELECT, INSERT, etc.', 5, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (9, 21, 'performance', 'How do I INSERT rows into a table?', 'INSERT INTO objectives(id, type, question, answer, sort)\nVALUES (21, w05d1, "How do I INSERT rows into a table?", "solution goes here",2);', 9, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (31, 21, 'learning', 'What are the four types of commands for databases?', 'DDL, DML, DCL, and TCL. See: https://stackoverflow.com/questions/2578194/what-are-ddl-and-dml', 8, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (7, 21, 'learning', 'What is an ERD?', 'In the context of databases, an ERD is a diagram that shows each table as an entity, and also shows the relationships between tables.', 7, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (1, 21, 'learning', 'What is a table?', 'A table is a set of data collected as columns and rows.', 1, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (30, 21, 'learning', 'What are the queries that correspond to the CRUD actions?', 'The CRUD queries are: INSERT, SELECT, UPDATE and DELETE.', 10, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (8, 21, 'performance', 'How do I create a table?', 'CREATE TABLE objectives\n(\n    id bigint,\n    day_id character varying(5),\n    type character varying(12),\n    question text,\n    answer text,\n    sort smallint\n)', 2, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (41, 12, 'learning', 'What is the main reason to use a templating system?', 'Separating business logic from the presentation layer (separation of concerns), enables specialization of roles for programmers.', 4, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (23, 19, 'performance', 'How do you set a maximum width on HTML elements?', '.these_elements { max-width: 135px; }', 4, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (25, 19, 'learning', 'What are the absolute length units available in CSS?', 'mm, cm, in, px, pt, pc (1 pc = 12 pt)', 5, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (22, 19, 'performance', 'How do you set a minimum width on HTML elements?', '.these_elements { min-width: 135px; }', 3, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (26, 19, 'learning', 'What are the relative length units available in CSS?', 'em, ex, ch, rem, vw, vh, vmin, vmax, %', 6, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (24, 19, 'performance', 'How should we set the web browser''s viewport?', '<meta name="viewport" content="width=device-width, initial-scale=1.0">', 2, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (10, 14, 'learning', 'Why would we never want to store passwords as plaintext?', 'To keep the passwords away from prying eyes, like hackers and website employees.', 2, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (39, 18, 'learning', 'What are some disadvantages of AJAX?', 'Creating dynamic content is tricky, asynchronous programming patterns are more complex to code, it requires js and XMLHTTPRequest support, history is not automatically updated.', 3, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (11, 14, 'learning', 'Rather than storing passwords as plaintext, how should they be stored?', 'Passwords should always be _hashed_. There is no need to encrypt them, since you never want to be able to see the password yourself.', 1, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (44, 12, 'learning', 'How, in NodeJS, do you write a route that accepts a dynamic value as part of the URL??', '```
app.get(''/path/:fuzz'', (req,res) => { 
  console.log(req.params.fuzz);
});
```
', 2, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (45, 12, 'learning', 'Does the order that your routes appear in your source code matter?', 'Yes. The order of the routes in your file matters. First matched -> First used.', 7, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (42, 12, 'learning', 'How do you code EJS templates?', '```
$> npm i ejs  
...
```
', 8, 120, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (46, 13, 'learning', 'How do you read a cookie value that arrives at a NodeJS program in the web request?', '```js
...
```', 4, 120, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (15, 16, 'learning', 'What is the basic syntax for a CSS ''Rule''?', '[selector] { style: value; ... } ', 3, 120, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (14, 16, 'learning', 'How do you set the preferred box model?', '* { box-sizing: border-box; }', 5, 120, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (63, 16, 'learning', 'What does it mean to say that with version 5, HTML became more ''semantic''?', 'The tags introduced in HTML 5 provide ways of describing the purpose and meaning of parts of a page. This is useful for developers, as well as crawlers and bots that are trying to find specific parts of a page to highlight.', 2, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (60, 16, 'learning', 'What are the three CSS styles most directly related to the box model for any given DOM element?', 'Margin, Border, Padding', 6, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (61, 16, 'learning', 'For the CSS styles that take 1,2 or 4 length parameters (padding, margin, etc.) how is each number of parameters interpreted?', 'For 1 parameter, all 4 sides of the box get the same value. For 2 parameters, the first is ''top'' and ''bottom'' and the second is ''left'' and ''right''. Four parameters specify each side, top, right, bottom and left, respectively.', 7, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (59, 16, 'learning', 'What is a Single Page App?', 'An SPA is an app that leverages AJAX to prevent page reloads. Instead it changes page content by manipulating the DOM directly, using front-end javascript.', 0, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (33, 23, 'performance', 'How do you connect to a Postgres DB from within Javascript?', 'const pg = require(''pg'');
const config = { 
  user: ''<user name>'',
  password: ''<password>'',
  database: ''<db>'',
...
.catch(err => console.error(''db connection error'', err.stack));', 1, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (64, 17, 'learning', 'What are some examples of Javascript objects that are only defined in the browser context?', 'window, navigator, document', 0, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (16, 17, 'performance', 'How do you create a new element using jQuery and dynamically append it to a DOM element?', '$(''<div class="newElement">Text content goes here.</div>'').appendTo($( ".container" ));', 2, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (65, 17, 'learning', 'What is DOM traversal?', 'DOM travsersal is the ability for client-side Javascript to move from one node of the DOM to another. Test.', 3, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (78, 31, 'learning', 'What is React''s Virtual DOM?', 'The virtual DOM is a copy of the DOM that it kept in memory. React does most of its work there, and then as a final step patches the actual DOM, but only where needed.', 0, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (79, 31, 'performance', 'How do you create a boilerplate React app?', 'On the terminal:

$> npx create-react-app name-of-app-goes-here
', 1, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (70, 19, 'learning', 'How do you define variables in SASS?', '$main-size: 2em;
$background-color: purple;', 7, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (81, 31, 'performance', 'How do you make your own HTML Tags using JSX?', 'In JSX, a new component can be made by creating a function that returns HTML.
...
{Button({text: ''click me''});', 5, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (17, 17, 'learning', 'What is DOM manipulation?', 'DOM manipulation is the ability of client-side javascript to add, remove or change parts of the DOM after the initial page load.', 1, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (57, 14, 'learning', 'How can you use verbs other than GET and POST in your HTML, given that you''re using a NodeJS back-end?', 'The method-override package: https://www.npmjs.com/package/method-override', 5, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (58, 14, 'learning', 'What package is available to help you implemented encrypted cookie values?', 'cookie-session: http://expressjs.com/en/resources/middleware/cookie-session.html', 6, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (37, 18, 'learning', 'What is AJAX?', 'Asynchronous Javascript and XML is a different paradigm of web request, where smaller amounts of data, or small parts of a webpage are sent and recieved in requests that do not result in page a refresh.', 0, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (56, 14, 'learning', 'What is REST?', 'REST is a convention for choosing paths and HTTP verbs for end-point routes.', 4, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (66, 18, 'performance', 'How do you invoke an AJAX request from jQuery?', '$.ajax({
  url: url,
  method: "GET", 
})
.then((result) => {
...
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (38, 18, 'learning', 'What are some advantages of AJAX?', 'No page reloads, faster page renders, improved response times, client side rendering reduces network load.', 2, NULL, NULL, 1);
...
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (77, 6, 'performance', 'How do you prevent files from being stored in your git repository?', 'Create a file named .gitignore
...
', 7, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (75, 6, 'learning', 'How do you export things from any given Javascript file?', 'module.exports = [AN EXPRESSION WITH A VALUE THAT REQUIRE WILL PICK UP];
...
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (73, 6, 'learning', 'What is Mocha?', 'Mocha is a testing framework. It looks for test files to run in the ./test/ folder.', 5, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (76, 6, 'learning', 'How do you bring in things that are exported from another Javascript file?', 'const thing = require("./path/to/javascript-file");', 1, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (72, 6, 'learning', 'What is Test Driven Development?', 'Tests are written before the code. The tests make the expectations of the code explicit. Red - Green - Refactor are the stages of code development. You make the code work (pass the tests!) and then you can refactor the code, safe in the knowledge that the code is relatively easily testable.', 2, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (74, 6, 'learning', 'What is Chai?', 'Chai is an assertion library. It defines a large number of assertions useful for testing.', 6, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (88, 33, 'learning', 'What is a pure function?', '1) The function only depends on its inputs to return a value.

2) Given the same input, the function always returns the same output.

3) It doesn''t produce changes beyond it''s scope.', 0, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (89, 33, 'learning', 'What are some common side-effects that, if you needed to do them, would make a pure function impure?', 'Writing to standard out (i.e. console.log()).
...
... the callback will only be called (after a render) when numVisitors changes.', 4, NULL, NULL, 1);
...
With React Router Dom, for example, all the endpoints are specified as a specific set of components that will be displayed for any given route.', 0, NULL, NULL, 1);
...
<Switch> enforces a ''first match only'' policy on <Route> tags. Switch tags can also be put on a sub-component. This helps display page specific content that needs to live inside a sub-component.', 1, NULL, NULL, 1);
...
State is controlled data that springs into existance when the useState function is called.', 3, NULL, NULL, 1);
...
To avoid that infinite loop, your event handler can be set to be a callback function. Then when the component rerenders, it will only establish that callback rather than invoking the state setter again. This breaks what would otherwise start an infinite loop of rendering/stateSetting/etc.', 5, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (98, 37, 'learning', 'Which hook allows your Front-End routing code to extract parameters from the URL?', 'useParams is a hook, provided by React Router Dom, that allows your code to extract URL parameters, just as req.params would do for node.js.', 2, NULL, NULL, 1);
...
While the app is still a ''single page app'', the app will load all of itself up on that deep link request, but then render the appropriate state to correspond to the link.', 3, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (100, 37, 'learning', 'How do you create Styled Components?', 'import styled from ''styled-components'';
...
// This is an inline style, that destroys separation of concerns. :-)', 5, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (101, 37, 'learning', 'How does useContext avoid prop drilling?', 'Prop drilling is where a component hierarchy passes props from grandparent down to a parent and then down to children, etc.
...
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (82, 32, 'learning', 'What are the two ways to set state on a React Component?', 'Let''s say you have some state set up thusly:
...
currentValue => 5;
', 2, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (48, 13, 'learning', 'What is a web cookie?', 'A cookie is a name/value pair that stores information related to a particular user on their browser by a certain domain.', 1, 120, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (47, 13, 'learning', 'How do you set a cookie value from within a NodeJS app?', '``` js
...
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (80, 31, 'learning', 'WTF?; DROP TABLE objectives; SELECT * FROM objectives ', 'JSX is a syntax that combines Javascript and HTML. For example, here is a line of valid JSX.
...
Adjacent HTML tags must have a parent.', 4, NULL, NULL, 1);
...
This enables your code to stay on its feet, to react to user input or other inputs, while at the same time, managing the underlying OS''s actions like reading files, downloading data from an API, gathering user input from a terminal, etc.', 0, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (107, 7, 'performance', 'How do you schedule a callback to be called (by the Event Loop) at some point in the future, after the current thread is finished?', 'setTimeout(callback, delay); // where callback is a function definition, and delay is a number of milliseconds minimum before the callback will be called. (It cannot be called at all, until after the current thread is done.)', 1, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (111, 7, 'learning', 'If you schedule a callback to be executed directly by the the Event Loop, can its return value be collected?', 'No.', 2, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (108, 7, 'learning', 'How can you configure a callback to be called at a regular interval?', 'setInterval(callback, timeBetweenCalls); // timeBetweenCalls is in milliseconds.', 3, NULL, NULL, 1);
...
For example: calling an API, reading a file, waiting for keystrokes of user input, waiting for mouse clicks on elements, etc.', 5, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (112, 9, 'learning', 'What is "callback hell"?', '"Callback hell" is a problem with code, where the hierarchy of callbacks has gone so deep that debugging the code has become difficult.', 0, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (115, 9, 'performance', 'Given a promise object, how to you attach a callback that would be called in the case that the promise is rejected?', '// the catch function (defined on all promise objects) is how you establish which
// callback should be called for the case when a promise is rejected.

const promise = <some object from some package or library that builds promises>;                                                                promise.catch( (error) => { console.log(error)} );', 5, NULL, NULL, 1);
...
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (117, 11, 'learning', 'What is a Route?', 'A route is the combination of HTTP Request Verb (GET, POST, etc.) and a Path ("/contact", etc.)

A web server chooses which code to build the specific response based on the route.', 2, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (118, 11, 'learning', 'What is Middleware?', 'In the context of an Express Web Server, middleware is code that will be executed for every route.

Examples include parsing cookie or form data from the request headers, performing debugging logging, and performing authentication tasks.', 4, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (12, 14, 'learning', 'What is the difference between encryption and hashing?', 'Hashing is one way, so you can''t recover the original text from the hash.', 0, NULL, NULL, 1);
...
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (113, 9, 'learning', 'In Javascript, what is a Promise?', '<div class="left">
...
https://medium.com/@dtkatz/3-ways-to-fix-the-cors-error-and-how-access-control-allow-origin-works-d97d55946d9', 4, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (131, 40, 'learning', 'What is the syntax for a constructor in Ruby?', '```
...
```', 4, 120, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (130, 40, 'learning', 'How do you instantiate an object in Ruby?', '
class Car
...
puts car
', 5, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (129, 40, 'learning', 'In Ruby, what is a lambda?', 'A lambda is a named block of code.
...
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (121, 39, 'learning', 'How do you use Classes to define components in React?', 'class OurComponent extends React.Component {
...
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (122, 39, 'learning', 'How are props handled in Class-based components?', 'Props are handed in as parameters to the constructor.
...
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (123, 39, 'performance', 'How is state handled in Class-based components?', 'class OurComponent extends React.Component {
...
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (124, 39, 'learning', 'What are three main lifecycle methods with Class-based components?', 'componentDidMount for set up  (axios call, setInterval, etc.)

componentDidUpdate opportunity for state values to be set

componentWillUnmount() for cleanup of intervals, prevent memory leaks', 7, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (133, 999, 'class', 'Coffee or Naan or Doggie Video?', 'Dog Of Course!', 1, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (134, 4, 'performance', 'How do you define a named function using a function statement?', '```
function nameOfFunction(parameter){
  // do stuff
}
```', 0, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (138, 4, 'learning', 'What is a callback?', 'A <span style="background-color:lightblue">callback</span> is a function that is passed as a parameter into another function.
...
```
', 2, 60, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (140, 4, 'learning', 'When can you omit much of the syntax used to define an arrow function?', 'If you only have one parameter, you can omit the parentheses around it.
...
x => x++ // this is an anonymous function expression', 6, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (139, 4, 'performance', 'How do you define an arrow function?', 'const functionValuedVariable = (parameter1, parameter2) => {
  // do stuff
};
', 5, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (142, 4, 'learning', 'When would you use a callback?', 'Callbacks are commonly used in two circumstances.
...
2) If you are trying to access the output of a function that will run asynchronously, you''ll use callbacks to gain access to that output. [This topic is explored in Week 2.]', 4, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (137, 4, 'performance', 'How do you define an anonymous function using a function expression?', '```
const functionValuedVariable = function (parameter) {
  // do stuff
};
```', 1, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (141, 4, 'learning', 'What is a higher-order function?', 'A function that accepts a callback as a parameter is called a <span style="background-color:lightblue">higher-order function</span>.
...
```
', 3, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (144, 6, 'learning', 'What is NPM and what does it stand for?', 'NPM, also known as Node Package Manager, is the largest collection of open source code on the planet.
...
This makes it less than ideal to use in any test driven development framework because once any test fails, the whole program would halt.', 4, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (145, 1, 'learning', 'Test SVG', '<div class="left">
# Title Sample Here
...
', 1, 60, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (146, 41, 'learning', 'How do you set an instance variable in a Ruby class?', '```
class Person
...
```
', 1, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (147, 41, 'learning', 'What table names are associated with Ruby classes while using Active Record?', '
...
| Deer | deers |
| Mouse | mice |
| Person | people |', 2, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (148, 41, 'learning', 'How do you create a Class that works with  Active Record to build the associated table?', '```
class Product < ApplicationRecord

end
```', 3, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (126, 40, 'learning', 'What are hashes in Ruby?', 'A hash is a collection of key value pairs.
...
', 1, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (127, 40, 'learning', 'What are symbols in Ruby?', 'A symbol is a lightweight string. They were introduced into the language to speed things up.
...
', 2, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (128, 40, 'learning', 'How are blocks of code written in Ruby?', 'A block of code is written with an ''do'' for before it, and an ''end'' after it.
...
NOTE: { } has also been added to the language', 3, 120, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (125, 40, 'performance', 'How does ''implicit return'' work in Ruby?', 'def say_hello first_name
  "hello there #{first_name}"
end

puts say_hello ''Alice''
', 0, NULL, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (149, 42, 'learning', 'What is the MVC code pattern?', 'MVC stands for Model, View, Controller.
...
A View is where data is interpolated into a template for display to the end-user.', 1, 120, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (155, 0, 'learning', 'Students will be able to successfully build, populate and use RDBMS-based SQL databases', '', 1, 120, 0, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (153, 0, 'learning', 'Students will be able to successfully build and test Javascript-based web applications.', '', 1, 120, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (114, 9, 'learning', 'Given a promise object, how do you attach a callback that should be run if it resolves?', '<div class="left">
...
', 3, 120, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (132, 40, 'learning', 'How can you quickly create getters and setters for an instance variable in a class in Ruby?', '```
...
```
', 6, 120, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (51, 12, 'learning', 'What do the CRUD and BREAD acronyms stand for?', '<div class="left">
...
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (50, 12, 'learning', 'In NodeJS, how do you accept values from an HTML form?', '```
app.post(''/path'', (req,res) => { 
  console.log(req.body.fuzz); 
});
```
', 5, 120, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (53, 13, 'learning', 'What does it mean to say that HTTP is ''stateless''?', 'The HTTP protocol itself is unable to associate one request with another. Each request starts from scratch. Cookies are a payload within the headers of a request that enable a server to identify the browser session/user.', 0, 120, NULL, 1);
...
Nodemon is a helper program, available in the npm repository, that will run node programs and restart them when required.', 6, 120, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (49, 13, 'learning', 'How does a web cookie''s value transmit from one computer to another?', '<div class="left">
...
', 2, 120, NULL, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (156, 19, 'performance', 'How do you create a CSS rule that will only be applied for small screens?', '@media only screen and (max-width: 500px) {
...
', 10, NULL, 1, 1);
INSERT INTO public.objectives (id, day_id, type, question, answer, sort, total_time, parent_id, curriculum_id) VALUES (157, 19, 'learning', 'What are some standard media query widths to try?', '<div class="left">
...
INSERT INTO public.tags (id, name) VALUES (13, 'response');
INSERT INTO public.tags (id, name) VALUES (14, 'express');
INSERT INTO public.tags (id, name) VALUES (15, 'npm');
